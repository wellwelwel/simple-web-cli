 ...
 * @param options
 */
export declare function defineConfig(options: Local): Local;
export declare function defineConfig(options: SFTP): SFTP;
export declare function defineConfig(options: FTP): FTP;
