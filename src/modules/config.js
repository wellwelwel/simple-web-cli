...
const setConfig = async () => {
   ...
   const dev = { ftp: output?.ftp?.start || false, sftp: output?.sftp?.start || false };
...
export const { source, to, dev, process_files, build, options, plugins, blacklist } = await setConfig();
